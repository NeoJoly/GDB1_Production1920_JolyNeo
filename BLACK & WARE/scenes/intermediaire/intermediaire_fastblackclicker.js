class intermediaire_fastblackclicker extends Phaser.Scene {
    constructor() {
      super('intermediaire_fastblackclicker');
    ...
    create(){
      ...
      // mise en place
      scene='intermediaire_fastblackclicker';
      nbclick=0;
      ...
      this.add.image(0,0,'goal_75').setOrigin(0,0);
