class novice_blackandwhitematches extends Phaser.Scene {
    constructor() {
      super('novice_blackandwhitematches');
    ...
    create(){
      ...
      // mise en place
      scene = 'novice_blackandwhitematches';
      ...
      forme1 = this.add.image(960,800,'triangle_noir').setScale(1.5).setVisible(true).setInteractive();
      ...
      forme4 = this.add.image(960,800,'triangle_blanc').setScale(1.5).setInteractive().setVisible(false);
      this.input.setDraggable(forme4);

      forme5 = this.add.image(960,800,'triangle_blanc').setScale(1.5).setInteractive().setVisible(false);
      ...
      forme7 = this.add.image(960,800,'rond_noir').setScale(1.5).setInteractive().setVisible(false);
      this.input.setDraggable(forme7);

      forme8 = this.add.image(960,800,'rond_blanc').setScale(1.5).setInteractive().setVisible(false);
    ...
    update(){
      ...
      if (forme1.x<1520 && forme1.x>1320 && forme1.y<440 && forme1.y>240) {
        forme1.destroy();
      ...
      if (forme4.x<600 && forme4.x>400 && forme4.y<440 && forme4.y>240) {
        forme4.destroy();
        forme5.setVisible(true);
      }

      if (forme5.x<600 && forme5.x>400 && forme5.y<440 && forme5.y>240) {
        forme5.destroy();
      ...
      if (forme7.x<900 && forme7.x>700 && forme7.y<280 && forme7.y>80) {
        forme7.destroy();
        forme8.setVisible(true);
      }

      if (forme8.x<1220 && forme8.x>1020 && forme8.y<280 && forme8.y>80) {
        forme8.destroy();
      }
      ...
      if (forme8.x<1220 && forme8.x>1020 && forme8.y<280 && forme8.y>80 && loopfalse == 0) {
        isEnd=0;
        loopfalse = 1;
        this.physics.pause();
