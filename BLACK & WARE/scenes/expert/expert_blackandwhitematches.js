class expert_blackandwhitematches extends Phaser.Scene {
    constructor() {
      super('expert_blackandwhitematches');
    ...
    create(){
      ...
      // mise en place
      scene = 'expert_blackandwhitematches';
      croix1 = "false";
      croix2 = "false";
      ...
      static5 = this.add.image(1420,340,'triangle_noir').setScale(1.5);
      ...
      forme1 = this.add.image(960,800,'rond_blanc').setScale(1.5).setVisible(true).setInteractive();
      this.input.setDraggable(forme1);

      forme2 = this.add.image(960,800,'rond_noir').setScale(1.5).setInteractive().setVisible(false);
      this.input.setDraggable(forme2);

      forme3 = this.add.image(960,800,'triangle_blanc').setScale(1.5).setInteractive().setVisible(false);
      this.input.setDraggable(forme3);

      forme4 = this.add.image(960,800,'croix_blanche').setScale(1.5).setInteractive().setVisible(false);
      this.input.setDraggable(forme4);

      forme5 = this.add.image(960,800,'carre_noir').setScale(1.5).setInteractive().setVisible(false);
      this.input.setDraggable(forme5);

      forme6 = this.add.image(960,800,'carre_blanc').setScale(1.5).setInteractive().setVisible(false);
      this.input.setDraggable(forme6);

      forme7 = this.add.image(960,800,'triangle_noir').setScale(1.5).setInteractive().setVisible(false);
      ...
      forme9 = this.add.image(960,800,'triangle_noir').setScale(1.5).setInteractive().setVisible(false);
      this.input.setDraggable(forme9);

      forme10 = this.add.image(960,800,'croix_noire').setScale(1.5).setInteractive().setVisible(false);
      this.input.setDraggable(forme10);

      forme11 = this.add.image(960,800,'carre_blanc').setScale(1.5).setInteractive().setVisible(false);
      this.input.setDraggable(forme11);

      forme12 = this.add.image(960,800,'rond_blanc').setScale(1.5).setInteractive().setVisible(false);
    ...
    update(){
      ...
      if (forme1.x<1220 && forme1.x>1020 && forme1.y<280 && forme1.y>80) {
        forme1.destroy();
        forme2.setVisible(true);
      }

      if (forme2.x<900 && forme2.x>700 && forme2.y<280 && forme2.y>80) {
        forme2.destroy();
        forme3.setVisible(true);
      }

      if (forme3.x<600 && forme3.x>400 && forme3.y<440 && forme3.y>240) {
        forme3.destroy();
      ...
      if (forme5.x<270 && forme5.x>70 && forme5.y<700 && forme5.y>500) {
        forme5.destroy();
        forme6.setVisible(true);
      }

      if (forme6.x<1850 && forme6.x>1650 && forme6.y<700 && forme6.y>500) {
        forme6.destroy();
        forme7.setVisible(true);
      }

      if (forme7.x<1520 && forme7.x>1320 && forme7.y<440 && forme7.y>240) {
        forme7.destroy();
      ...
      if (forme9.x<1520 && forme9.x>1320 && forme9.y<440 && forme9.y>240) {
        forme9.destroy();
      ...
      if (forme11.x<1850 && forme11.x>1650 && forme11.y<700 && forme11.y>500) {
        forme11.destroy();
      ...
      if (forme12.x<1220 && forme12.x>1020 && forme12.y<280 && forme12.y>80 && loopfalse == 0) {
        isEnd=0;
        loopfalse = 1;
        this.physics.pause();
      ...
      if (isEnd == 1 && loopfalse == 0 || forme4.x<270 && loopfalse == 0 || forme4.x>1650 && loopfalse == 0 || forme4.y<700 && loopfalse == 0 || forme10.x<270 && loopfalse == 0 || forme10.x>1650 && loopfalse == 0 || forme10.y<700 && loopfalse == 0 ) {
        isEnd=0;
        loopfalse = 1;
        this.physics.pause();
