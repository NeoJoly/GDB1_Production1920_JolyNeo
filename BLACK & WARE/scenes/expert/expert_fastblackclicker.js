class expert_fastblackclicker extends Phaser.Scene {
    constructor() {
      super('expert_fastblackclicker');
    ...
    create(){
      ...
      this.add.image(0,0,'goal_100').setOrigin(0,0);
