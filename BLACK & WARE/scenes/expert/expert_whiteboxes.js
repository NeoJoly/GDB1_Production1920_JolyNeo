class expert_whiteboxes extends Phaser.Scene {
    constructor() {
      super('expert_whiteboxes');
    ...
    update(){
        ...
        if (casecounter==0) {
            wbcaseblanche15.setVisible(true);
        }
        if (casecounter==1) {
            wbcaseblanche15.setVisible(false);
            wbcaseblanche4.setVisible(true);
        }
        if (casecounter==2) {
            wbcaseblanche4.setVisible(false);
            wbcaseblanche6.setVisible(true);
        }
        if (casecounter==3) {
            wbcaseblanche6.setVisible(false);
            piege1="true";
        }
        ...
        if (casecounter==4) {
            wbcaseblanche15.setVisible(false);
            wbcaseblanche1.setVisible(true);
        }
        if (casecounter==5) {
            wbcaseblanche1.setVisible(false);
            wbcaseblanche2.setVisible(true);
        }
        if (casecounter==6) {
            wbcaseblanche2.setVisible(false);
            wbcaseblanche9.setVisible(true);
        }
        if (casecounter==7) {
            wbcaseblanche9.setVisible(false);
        ...
        if (casecounter==12) {
            ...
            wbcaseblanche12.setVisible(true);
        }
        if (casecounter==13) {
            wbcaseblanche12.setVisible(false);
